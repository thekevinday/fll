...
extern int __wrap_cap_from_name(const char * const name, cap_value_t *value);
extern cap_t __wrap_cap_from_text(const char * const text);
extern int __wrap_cap_get_bound(cap_value_t value);
extern cap_t __wrap_cap_get_fd(int descriptor);
extern cap_t __wrap_cap_get_file(const char * const path);
...
extern int __wrap_cap_set_file(const char * const path, cap_t capability);
