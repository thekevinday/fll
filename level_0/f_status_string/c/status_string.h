...
extern "C" {
  ...
  extern const f_string_static_t f_status_packet_too_large_s;
  extern const f_string_static_t f_status_packet_too_large_not_s;
  extern const f_string_static_t f_status_packet_too_small_s;
  extern const f_string_static_t f_status_packet_too_small_not_s;
