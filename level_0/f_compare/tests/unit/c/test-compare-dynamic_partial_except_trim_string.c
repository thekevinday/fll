...
void test__f_compare_dynamic_partial_except_trim_string__works(void **state) {
  ...
  for (; i < 8; ++i) {
    ...
    if (i % 8 == 0) {
      ...
      status = f_compare_dynamic_partial_except_trim_string(string_1s[i].string, string_2s[i], 0, range_2, excepts_1, excepts_2);
    }
  ...
  for (; i < 64; ++i) {
    ...
    if (i % 8 == 0) {
      ...
      status = f_compare_dynamic_partial_except_trim_string(string_1s[i].string, string_2s[i], range_1.stop + 1, range_2, excepts_1, excepts_2);
    }
