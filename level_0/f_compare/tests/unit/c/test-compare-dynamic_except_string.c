...
void test__f_compare_dynamic_except_string__works(void **state) {
  ...
  for (; i < 64; ++i) {
    ...
    const f_status_t status = f_compare_dynamic_except_string(string_1s[i].string, string_2s[i], string_1s[i].used, excepts_1, excepts_2);
  ...
  for (i = 0; i < 64; ++i) {
    ...
    const f_status_t status = f_compare_dynamic_except_string(string_2s[i].string, string_1s[i], string_2s[i].used, excepts_2, excepts_1);
