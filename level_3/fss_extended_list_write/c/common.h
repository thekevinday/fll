 ...
 */
  ...
  #define FSS_EXTENDED_LIST_WRITE_program_version_micro_s F_string_ascii_1_s
  ...
  #define FSS_EXTENDED_LIST_WRITE_program_version_micro_s_length F_string_ascii_1_s_length
