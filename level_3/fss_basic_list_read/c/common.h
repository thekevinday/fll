 ...
 */
  ...
  #define FSS_BASIC_LIST_READ_program_version_micro_s F_string_ascii_7_s
  ...
  #define FSS_BASIC_LIST_READ_program_version_micro_s_length F_string_ascii_7_s_length
