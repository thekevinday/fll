...
extern "C" {
  ...
  void fss_extended_read_setting_load(const f_console_arguments_t arguments, fll_program_data_t * const main, fss_extended_read_setting_t * const setting) {
    ...
    main->setting.state.step_small = fss_extended_read_allocation_console_d;

    f_console_parameter_process(arguments, &main->program.parameters, &main->setting.state, 0);

    main->setting.state.step_small = fss_extended_read_allocation_small_d;

    // Identify and pocess first/last parameters.
    if (main->program.parameters.array[fss_extended_read_parameter_line_first_no_e].result & f_console_result_found_e) {
      main->setting.flag -= main->setting.flag & fss_extended_read_main_flag_print_first_e;
    }
    else {
      main->setting.flag |= fss_extended_read_main_flag_print_first_e;
    }

    if (main->program.parameters.array[fss_extended_read_parameter_line_last_no_e].result & f_console_result_found_e) {
      main->setting.flag -= main->setting.flag & fss_extended_read_main_flag_print_last_e;
    }
    else {
      main->setting.flag |= fss_extended_read_main_flag_print_last_e;
    }
    ...
    if (main->program.parameters.array[fss_extended_read_parameter_help_e].result & f_console_result_found_e) {
      main->setting.flag |= fss_extended_read_main_flag_help_e;

      return;
    }

    if (main->program.parameters.array[fss_extended_read_parameter_version_e].result & f_console_result_found_e) {
      main->setting.flag |= fss_extended_read_main_flag_version_e;

      return;
    }

    if (main->program.parameters.array[fss_extended_read_parameter_copyright_e].result & f_console_result_found_e) {
      main->setting.flag |= fss_extended_read_main_flag_copyright_e;
    ...
    if (main->program.parameters.array[fss_extended_read_parameter_strip_invalid_e].result & f_console_result_found_e) {
      main->setting.flag |= fss_extended_read_main_flag_strip_invalid_e;
    }
  }
