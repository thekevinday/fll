 ...
 */
  ...
  #define FSS_EMBEDDED_LIST_READ_program_version_micro_s F_string_ascii_1_s
  ...
  #define FSS_EMBEDDED_LIST_READ_program_version_micro_s_length F_string_ascii_1_s_length
