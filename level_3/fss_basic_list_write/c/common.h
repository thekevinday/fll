 ...
 */
  ...
  #define FSS_BASIC_LIST_WRITE_program_version_micro_s F_string_ascii_6_s
  ...
  #define FSS_BASIC_LIST_WRITE_program_version_micro_s_length F_string_ascii_6_s_length
