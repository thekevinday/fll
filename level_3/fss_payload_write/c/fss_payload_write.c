...
extern "C" {
  ...
  f_status_t fss_payload_write_print_help(const f_file_t file, const f_color_context_t context) {
    ...
    fll_program_print_help_option(file, context, fss_payload_write_short_partial_s, fss_payload_write_long_partial_s, f_console_symbol_short_enable_s, f_console_symbol_long_enable_s, "Do not write a complete Object and Content set.");
