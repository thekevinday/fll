 ...
 */
#ifndef _PRIVATE_fss_payload_read_h
#define _PRIVATE_fss_payload_read_h
...
/**
 * Perform the payload read processing on the buffer.
 *
 * This will print an error message on error.
 *
 * @param main
 ...
 *   F_none on success.
 *
 *   Errors (with error bit) from: fss_payload_read_load()
 *   Errors (with error bit) from: fss_payload_read_process_option()
 *
 * @see fss_payload_read_load()
 * @see fss_payload_read_process_option()
 */
...
/**
 * Process based on at parameter for the FSS-0001 Extended Content at depth 1.
 *
 * @param main
 *   The main program data.
 * @param data
...
/**
 * Process based on columns parameter for the FSS-0001 Extended Content at depth 1.
 *
 * @param main
 *   The main program data.
 * @param data
...
/**
 * Process based on line parameter for the FSS-0001 Extended Content at depth 1.
 *
 * @param main
 *   The main program data.
 * @param data
...
/**
 * Process the Objects in the buffer, determining if the Object name is to be used or not for the FSS-0001 Extended Content at depth 1.
 *
 * How an Object name is determined to be used or not is dependent on several parameters, such as --name, --depth, --at, and --line.
 *
 * @param data
 ...
 *   F_none on success.
 *
 *   Errors (with error bit) from: fss_payload_read_load_setting()
 *
 * @see fll_fss_payload_read()
 *
...
/**
 * Process based on total parameter for the FSS-0001 Extended Content at depth 1.
 *
 * @param main
 *   The main program data.
 * @param data
...
#endif // _PRIVATE_fss_payload_read_h
