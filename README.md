...
The other build modes, **level** and **individual**, may be accessed by downloading the repo with the appropriate version tag and using the bootstrap.sh build script.
...
The UTF-8 work is ongoing and incomplete, but most of the incomplete work is in interpreting the UTF-8 for FSS and similar uses.
Therefore the UTF-8 presentation here should be *relatively* correct in operation.

### Program - Control
This project is not yet started but development will begin following the FLL-0.5.4 development release.

The goal of this is to communicate with the "Controller" program, such as starting or stopping services.

### Program - Controller
This project is under active development as of the FLL-0.5.4 development release.
...
These are currently incomplete with the read programs mostly working and the write programs mostly incomplete.
...
This is a group of programs used to translate status codes from a numeric representation to a more human-readably text representation.
...
The project can be installed using the latest release tag, such as 0.5.4:
- https://github.com/thekevinday/fll/releases
...
The latest version, which at the time of this documentation write-up is a 0.5.x release.
- https://sourceforge.net/projects/fll/files/FLL-0.5/0.5.4/

The main pre-packaged FLL release, which is pre-packaged for **monolithic** build mode, is called fll-0.5.4.tar.gz.
- https://sourceforge.net/projects/fll/files/FLL-0.5/0.5.4/monolithic/fll-0.5.4.tar.gz/download
