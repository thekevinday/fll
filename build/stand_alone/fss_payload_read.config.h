// A config.h file for defining all code being disabled for compiling the stand alone FSS Payload Read.
// To assist in building this file use (may need to omit --defined-only): "nm --defined-only -f p programs/shared/fss_payload_read | grep -oP '^(f|fl|fll|macro)_[^\s]+'".
