// A config.h file for defining all code being disabled for compiling the stand alone FSS Extended Write.
// To assist in building this file use (may need to omit --defined-only): "nm --defined-only -f p programs/shared/fss_extended_write | grep -oP '^(f|fl|fll|macro)_[^\s]+'".
