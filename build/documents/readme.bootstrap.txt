...
Bootstrap Readme Documentation:
  ...
  Build tree structure example (using the abbreviation-FLL:"Featureless Linux Library" code:"status_code-0.6.6" project)\:
    block:"
      build/
      ├── documents
      ├── includes
  ...
  Work tree Structure example at file:"/tmp/work" (using the abbreviation-FLL:"Featureless Linux Library" code:"status_code-0.6.6" project)\:
    block:"
      /tmp/work/
      ├── includes
      │   └── program
