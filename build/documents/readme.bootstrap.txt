...
Bootstrap Readme Documentation:
  ...
  Build tree structure example (using the abbreviation-FLL:"Featureless Linux Library" code:"status_code-0.6.3" project)\:
    block:"
      build/
      ├── documents
      ├── includes
      ...
      │   │   ├── libstatus_code.so.0.6 -> libstatus_code.so.0.6.3
      │   │   └── libstatus_code.so.0.6.3
      │   └── static
      │       └── libstatus_code.a
      ├── objects
      │   ├── common.o
  ...
  Work tree Structure example at file:"/tmp/work" (using the abbreviation-FLL:"Featureless Linux Library" code:"status_code-0.6.3" project)\:
    block:"
      /tmp/work/
      ├── includes
      │   └── program
