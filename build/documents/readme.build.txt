...
Build Readme Documentation:
  ...
  Build Tree Structure Example (using the status_code-0.5.6 project)\:
    build/
    ├── documents
    ├── includes
    │   └── level_3
    ...
    │   │   ├── libstatus_code.so.0 -> libstatus_code.so.0.5.6
    │   │   └── libstatus_code.so.0.5.6
    │   └── static
    │       └── libstatus_code.a
    ├── objects
  ...
  Work Tree Structure Example at '/tmp/work' (using the status_code-0.5.6 project)\:
    /tmp/work/
    ├── includes
    │   └── level_3
    │       └── status_code.h
